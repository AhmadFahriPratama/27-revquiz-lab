...
An interactive quiz and assessment platform to track scores, attempts, and difficulty metrics.

## What this project does

Build interactive quizzes, run assessments, and evaluate performance instantly.

## Project goal

A quiz platform for assessments, attempts, category tracking, and leaderboard context.
